...
export const businessesTable = pgTable("businesses", {
  ...
  lastHvacPermitYear: integer("last_hvac_permit_year"),
  lastMajorRenovationYear: integer("last_major_renovation_year"),
  ownerOccupied: boolean("owner_occupied"),
  livingAreaSqft: integer("living_area_sqft"),
  amiBand: text("ami_band"),
  utilityProvider: text("utility_provider"),
  subdivision: text("subdivision"),
  neighborhood: text("neighborhood"),
  replacementScore: integer("replacement_score"),
  priorityGrade: text("priority_grade"),
  scoreReasons: text("score_reasons"),
  recommendedPitch: text("recommended_pitch"),
